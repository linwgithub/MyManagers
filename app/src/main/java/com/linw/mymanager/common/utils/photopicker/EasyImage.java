...
public class EasyImage implements EasyImageConfig {
    ...
    private static final String KEY_PHOTO_URI = "com.pollysoft.easyphotopicker.photo_uri";
    private static final String KEY_LAST_CAMERA_PHOTO = "com.pollysoft.easyphotopicker.last_photo";
